...
console.log('--- SYNCING DIST & BUMPING ASSET CACHE TO v=88.0 ---');
...
htmlFiles.forEach(file => {
  ...
  content = content.replace(/\?v=\d+\.\d+/g, '?v=88.0');
  fs.writeFileSync(filePath, content, 'utf8');
});
console.log(`Bumped cache version to ?v=88.0 across ${htmlFiles.length} root HTML files.`);
