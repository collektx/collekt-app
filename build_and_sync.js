...
console.log('--- SYNCING DIST & BUMPING ASSET CACHE TO v=81.0 ---');
...
htmlFiles.forEach(file => {
  ...
  content = content.replace(/\?v=\d+\.\d+/g, '?v=81.0');
  fs.writeFileSync(filePath, content, 'utf8');
});
console.log(`Bumped cache version to ?v=81.0 across ${htmlFiles.length} root HTML files.`);
